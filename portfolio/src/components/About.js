    ...
    return (
      <div className='wrapper about'>
        ...
        <div className="flex">
            ...
            <p>Francheska is currently open to new opportunities as a Web Developer, either remote or based in Puerto Rico, since she will be moving there in March 2019.</p>
        </div>
      </div>
    );
  }
