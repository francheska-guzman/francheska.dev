      ...
      <div className='wrapper about'>
        ...
        <div className="flex">
	        <img src={picture} alt="Francheska Guzman" />
                <p className="introduction">Francheska has born and raised in Puerto Rico. She has 8+ years of combined experience in manual and automated software testing, quality assurance, and web development. Francheska is currently working as a Software Test Engineer II at <a href="https://abarcahealth.com" target='_blank'>Abarca Health</a>, a Pharmacy Benefit Manager (PBM) company.</p>
        </div>
      </div>
    );
  }
