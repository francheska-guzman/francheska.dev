    ...
    return (
      <div className='wrapper about'>
        ...
        <div className="flex">
	        ...
	        <p className="introduction">Francheska is a passionate web developer based in Puerto Rico. She has worked for over a year coding, testing, and delivering E-mail Marketing Campaings, as well as provide website maintenance to the <a href="https://www.nyfa.edu/" target="_black">New York Film Academy</a> – School of Film and Acting (NYFA). Her most recent project is coding and testing the new version of the NYFA's online applications.</p>
