      ...
      <div className='wrapper about'>
        ...
        <div className="flex">
	        <img src={picture} alt="Francheska Guzman" />
                <p className="introduction">Francheska is a passionate web developer and software tester who has a background in business administration. In late 2019 she started working at <a href="https://invidgroup.com" target="_black">INVID</a>, a full-service information technology company based in San Juan, Puerto Rico. </p>
