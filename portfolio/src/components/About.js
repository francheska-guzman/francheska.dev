  ...
  render() {
    return (
      <div className='wrapper about'>
        <h2>About</h2>
        <div className="flex">
	        <img src={picture} alt="Francheska Guzmán" />
	        <p className="introduction">Francheska is a passionate full stack developer and software tester based in Carolina, Puerto Rico.</p>
