    ...
    return (
      <div className='wrapper about'>
        ...
        <div className="flex">
	        ...
	        <p className="introduction">Francheska is a passionate web developer based in Puerto Rico. She worked for over a year coding and delivering E-mail Marketing Campaings, as well as provide website maintenance to the <a href="https://www.nyfa.edu/" target="_black">New York Film Academy</a>.</p>
