      ...
      <div className='wrapper about'>
        ...
        <div className="flex">
	        <img src={picture} alt="Francheska Guzman" />
                <p className="introduction">Francheska is a passionate web developer and software tester with 5 years of combined experience. She currently works at <a href="https://invidgroup.com" target="_black">INVID</a>, a full-service information technology company based in San Juan, PR.</p>
