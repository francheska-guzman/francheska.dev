    ...
    return (
      <div className='wrapper about'>
        ...
        <div className="flex">
          ...
          <p>In addition to tech, her major interests and hobbies are: ride bikes, sewing, dance salsa, continue learning American Sign Language, finance, culture, and last but not least spend quality time with family and friends.</p>
        </div>
      </div>
    );
  }
